...
export const timelineData: TimelineMoment[] = [
  {
    ...
    photoUrl: '/images/gallery/photo1.jpeg',
    photoCaption: 'Warkop Cakasa, tempat pertama kali nyapa ☕',
    highlights: ['Warkop Cakasa', 'Malam Nggak Sengaja', 'Kopi Pertama']
  },
  {
    id: 'momen-2',
    order: 2,
    title: 'Masa-Masa PDKT',
    dateStr: 'Akhir September - Oktober 2025',
    location: 'Cakasa & Hood Cipinang',
    badge: 'Nempel Terus',
    story: 'Abis malam itu, obrolan kita makin nyambung aja. Arya rajin antar-jemput Nadina ke kampus, terus hampir tiap balik pasti mampir ngopi dulu di Hood Cipinang. Dari rutinitas kecil sama obrolan random sepulang kampus gini, rasa nyaman pelan-pelan makin kerasa.',
    photoUrl: '/images/gallery/photo2.jpg',
    photoCaption: 'Hood Cipinang, spot wajib abis jemput dia dari kampus 🍵',
    highlights: ['Antar Jemput Kampus', 'Hood Cipinang', 'Obrolan Random']
  },
  {
    id: 'momen-3',
    order: 3,
    title: 'Niat ke Puncak & Resmi Jadian',
    ...
    photoUrl: '/images/gallery/photo3.jpeg',
